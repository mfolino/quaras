...
<!-- Main CSS-->
<link rel="stylesheet" type="text/css" href="/css/variables.css.php">
...
<link rel="stylesheet" type="text/css" href="/css/custom.css?v=<?=filemtime($_SERVER["DOCUMENT_ROOT"].'/css/custom.css')?>">
