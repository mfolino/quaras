...
<head>
    ...
    <? if($_SERVER["REMOTE_ADDR"] == "190.231.245.234" && false){ ?>
        <style>
            h1,h2,h3,h4,h5,p,span,div,b{
                font-family:'Hind', Helvetica, Arial, sans-serif !important;
                color:#71777D!important;
            }
            .newStylesSubtituloMail{
        ...
        <tbody>
            <tr style="vertical-align: top">
                ...
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #FFFFFF;"><![endif]-->
                    ...
                    <? 
                        $colorFondo = $general["fondoAbajo"] ? "ffffff" : $general['colorPrimario']; 
                        $colorFecha = $general["fondoAbajo"] ? '000000' : "ffffff"; 
                    ?>
                                ...
                                <div class="col num6" style="max-width: 320px;min-width: 310px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div align="left" class="img-container left fullwidthOnMobile fixedwidth " style="padding-right: 0px;  padding-left: 0px;">
                                            ...
                                            <? if($general["mails_quitarEnlaceLogo"]){ ?>
                                                <img class="left fullwidthOnMobile fixedwidth" align="left" border="0" src="http://<?=$general['clientDomain']?>/img/<?=$general['logo']?>" alt="<?=$general['nombreCliente']?>" title="<?=$general['nombreCliente']?>" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 150px; margin-top:15px; margin-bottom:15px" width="150">
                                            <? }else{ ?>
                                                <a href="https://<?=$general['clientDomain']?>" target="_blank">
                                                    <img class="left fullwidthOnMobile fixedwidth" align="left" border="0" src="http://<?=$general['clientDomain']?>/img/<?=$general['logo']?>" alt="<?=$general['nombreCliente']?>" title="<?=$general['nombreCliente']?>" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 150px; margin-top:15px; margin-bottom:15px" width="150">
                                                </a>
                                            <? } ?>
                                ...
                                <div class="col num6" style="max-width: 320px;min-width: 310px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div class="">
                                            ...
                                            <div style="color:#<?=($general['logoFooter']=='black') ? 'FFFFFF' : '555555'?>;font-family:'Hind', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 15px; padding-bottom: 15px;">	
                                                <div style="font-size:12px;line-height:14px;font-family:inherit;color:#<?=($general['logoFooter']=='black') ? 'FFFFFF' : '555555'?>;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: right; color: #<?=$colorFecha?>"><?=date("d/m/Y H:i")?></p></div>	
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                        </div>
                                ...
                                <div class="col num12" style="min-width: 320px;max-width: 620px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div class="">
                                            ...
                                            <div style="color:#000000;font-family:'Hind', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">	
                                                <div style="font-size:12px;line-height:14px;font-family:'Hind', Helvetica, Arial, sans-serif;color:#000000;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: <?=$alineacionTituloMail?>"><strong style="background-color: transparent;"><span style="font-size: 18px; line-height: 21px;"><?=$tituloMail?></span></strong><br></p></div>	
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                        </div>
                                        ...
                                        <div class="">
                                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;"><![endif]-->
                                            <div style="color:#71777D;font-family:'Hind', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">	
                                                <div style="font-size:12px;line-height:14px;font-family:'Hind', Helvetica, Arial, sans-serif;color:#71777D;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: <?=$alineacionSubtituloMail?>"><?=$subtituloMail?></p></div>	
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                        </div>
                                ...
                                <div class="col num12" style="min-width: 320px;max-width: 620px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider " style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                            <tbody>
                                                <tr style="vertical-align: top">
                                                    <td class="divider_inner" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-right: 10px;padding-left: 10px;padding-top: 30px;padding-bottom: 20px;min-width: 100%;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                        <table class="divider_content" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 1px solid #CCCCCC;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                            <tbody>
                                                                <tr style="vertical-align: top">
                                                                    <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                        <span></span>
                                ...
                                <div class="col num12" style="min-width: 320px;max-width: 620px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div class="">
                                            ...
                                            <div style="color:#555555;line-height:120%;font-family:'Hind', Helvetica, Arial, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
                                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Hind', Helvetica, Arial, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><?=$textoPie?></p></div>	
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                        </div>
                    ...
                    <div style="background-color:#0e0e0e;">
                        <div style="Margin: 0 auto;min-width: 320px;max-width: 620px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:#0e0e0e;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 620px;"><tr class="layout-full-width" 	style="background-color:transparent;"><![endif]-->
                                ...
                                <div class="col num12" style="min-width: 320px;max-width: 620px;display: table-cell;vertical-align: top;">
                                    <div style="background-color: transparent; width: 100% !important;">
                                        ...
                                        <div class="">
                                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
                                            <div style="color:#888888;font-family:'Hind', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">	
                                                <div style="font-size:12px;line-height:14px;font-family:'Hind', Helvetica, Arial, sans-serif;color:#888888;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 12px; line-height: 14px;">© <?=date("Y")?> <a href="//turnos.app" style="color:#fff;text-decoration:none">Turnos.app</a>. Todos los derechos reservados.&#160;</span><span style="font-size: 12px; line-height: 14px;"><a style="color:#eb0084;text-decoration: underline;" href="example.com" target="_blank" rel="noopener"></a></span></p></div>	
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                        </div>
